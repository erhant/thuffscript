...
const foo = new Macro('FOO', {takes: 1}).body(
  '<adfdsds>', // add number 1 and 2 and put the result onto the stack
...
const main = new Main().body(
  ...
  [0x04, 'calldataload', foo.call({})],
  addConstant.call({constant: 100})
);
